...
class ProtocolExposureHomeworkRecording extends Component {
 constructor(props) {
   super(props);
   this.state = {};
 }
 ...
 render() {
  ...
  <React.Fragment>
      <div className={classes.container}>
          ...
          <h1>Exposure Homework Recording</h1>
          <Formik 
...
export default withStyles(styles)(ProtocolExposureHomeworkRecording);
